...
<script>
  ...
  (function(){
    ...
    function origenFromCosecha(c){
      ...
      const KPI  = new Set([
        'BBVA1','BBVA2','CAJAAQP1','CAJAAQP2','CAJAAQP4','CAJAAQP5','COMPARTAMOS_1','CONFIANZA','CONFIANZA_2','CONFIANZA_3',
  ...
  /* ===== Eliminar Pagos (solo si el usuario tiene permisos) ===== */
  (() => {
    const toggle = document.getElementById('toggleDeletePagos'); // switch "Eliminar pagos"
    if (!toggle) return; // No hay permisos o no existe el bloque
    ...
    // Habilitar botón al marcar filas
