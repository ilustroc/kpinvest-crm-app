...
@push('head')
  @vite([
    'resources/css/integracion/ccd.css',
    'resources/js/integracion/ccd.js',
  ])
@endpush
    ...
    <form method="POST"
      ...
      <div class="space-y-2">
        ...
        <div class="text-xs text-slate-500">
          Encabezados: <strong class="text-slate-700">dni, nombre, cartera, pdf</strong>
        </div>
      </div>

      {{-- Precheck (igual estilo que Pagos) --}}
      <div class="hidden" id="precheckBoxCCD">
        ...
        <div class="flex flex-wrap items-center gap-4">
          <div class="flex items-center gap-2">
            ...
            <span class="kp-mini" id="hdrMsgCCD" aria-live="polite">Validando encabezados…</span>
          </div>
          ...
          <div class="flex items-center gap-2">
            ...
            <span class="kp-mini" id="typeMsgCCD" aria-live="polite">Muestra: —</span>
          </div>
        </div>

        <div class="mt-3 hidden" id="issuesWrapCCD">
          <div class="kp-table">
            <table class="min-w-full text-sm">
              ...
              <tbody id="issuesBodyCCD" class="divide-y divide-slate-200/60"></tbody>
            </table>
          </div>
        </div>
      </div>
