...
<style>
  ...
  /* Caja de pre-check */
  #precheckBoxPropia{ background:color-mix(in oklab, var(--surface-2) 35%, transparent); border:1px dashed var(--border); border-radius:12px; padding:.6rem .75rem }
</style>
@endpush
    ...
    <form method="POST" action="{{ route('integracion.pagos.import') }}" enctype="multipart/form-data" class="row g-2 align-items-end" id="formImportPropia">
      ...
      <div class="col-12 d-none" id="precheckBoxPropia">
        ...
        <div class="d-flex flex-wrap align-items-center gap-3">
          <div><i class="bi bi-check-circle-fill ok me-1"></i><span class="mini" id="hdrMsgPropia" aria-live="polite">Validando encabezados…</span></div>
          <div><i class="bi bi-123 warn me-1"></i><span class="mini" id="typeMsgPropia" aria-live="polite">Tipos por muestra: —</span></div>
        </div>
